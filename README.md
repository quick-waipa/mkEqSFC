...
***
## コツなど：
- フィルター後のターゲットは5000Hz以上のピークにはあまり合わせすぎない方がいいかもしれません。合わせるとだいぶ煌びやかになります。
- ターゲットをフラットにする場合はディップをあまり埋めすぎない方がいいような気がします。
- 特にヘッドフォンの場合はディップは必要上存在している場合があるので埋めすぎない方がいいかもしれません。
- αをどちらに全振りしてもそれなりに聴けるのが正しい調整だと思われます。
- 当たり前ですが測定によってかなり結果が変わります。複数回計測して平均化するなど、色々試すといいかもしれません。
